...
package
{
	...
	/**	
	 * Sample application for using the GooglePlayServices Native Extension
	 * 
	 * @author	Michael Archbold
	 */
	public class TestGooglePlayServices extends Sprite
	{
		 ...
		 * Class constructor 
		 */	
		public function TestGooglePlayServices( appKey:String=APP_KEY )
		{
			super();
			_appKey = appKey;
			create();
		...
		private function init( ):void
		{
			try
			{
				...
				message( "GooglePlayServices Supported: " + GooglePlayServices.isSupported );
				message( "GooglePlayServices Version:   " + GooglePlayServices.service.version );
